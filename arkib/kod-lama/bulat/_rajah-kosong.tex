...
\startMPcode
picture LakaranB; LakaranB := image (
  ...
  draw Bulan xyscaled 3.00cm shifted (-1.25cm,-3.5cm);
  draw Bulan xyscaled 2.67cm shifted (- .58cm,-3.5cm); % r = 2.67 unit
  fill Bulan xyscaled 2.67cm shifted ( 1.45cm,-3.5cm) withcolor white;
...
\hskip.5cm Kod lakaran (bulatan pada bahagian dalam anak bulan):
\tfx \typebuffer[rajah]
