...
\startMPcode
  draw image (
    ...
    draw fullcircle scaled 6cm shifted (-1.25cm,0); % Bulan %
    draw fullcircle xyscaled (5.5cm,5.2cm) shifted (-.5cm,0);
    fill fullsquare xyscaled (1.8cm,4.9cm) %to hide the overlapping lines
      shifted (1.43cm,0) withcolor white;
...
\hskip.2cm Kod lakaran (elips pada bahagian dalam anak bulan):
\blank[-1*small]
